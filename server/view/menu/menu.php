...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <?php $page = 'menu'; // ubah sesuai halaman ?>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Daftar Menu Makanan & Minuman</h6>
              </div>
            </div>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <?php 
                    $no = 1;
                    $query = mysqli_query($koneksi, "SELECT * FROM menu ORDER BY jenis, nama_menu");
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if($m['gambar']): ?>
                          <img src="/assets/img/menu/<?= $m['gambar'] ?>" class="rounded" width="60" height="60" style="object-fit:cover;">
                        <?php else: ?>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?= htmlspecialchars($m['nama_menu']); ?></h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <span class="badge badge-sm <?= $m['jenis']=='Makanan' ? 'bg-gradient-success' : 'bg-gradient-info'; ?>">
                          <?= $m['jenis']; ?>
                        </span>
                      </td>
                      <td><span class="text-secondary text-xs font-weight-bold">Rp <?= number_format($m['harga'],0,',','.'); ?></span></td>
                      <td class="align-middle text-center">
                        <a href="menu_edit.php?id=<?= $m['id_menu']; ?>" class="text-warning font-weight-bold text-xs me-2" title="Edit">
                          <i class="material-symbols-rounded">edit</i>
                        </a>
                        <a href="menu_hapus.php?id=<?= $m['id_menu']; ?>" class="text-danger font-weight-bold text-xs" 
                           onclick="return confirm('Yakin hapus menu <?= $m['nama_menu']; ?>?')">
