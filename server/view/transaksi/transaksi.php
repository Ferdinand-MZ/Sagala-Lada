                  ...
                  <tr>
                    ...
                    <td>
                      <span class="badge badge-sm 
                        ...
                        <?= $t['metode_bayar']; ?>
                      </span><!-- Modal Detail Transaksi -->
<div class="modal fade" id="modalTransaksiDetail" tabindex="-1" aria-hidden="true">
...
function showDetail(id) {
  ...
  document.getElementById('idTransaksi').textContent = id.toString().padStart(4, '0');
